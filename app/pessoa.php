...
<body>
   <div class="questionario">
      ...
      <div class="form-inner">
         ...
         <form action="endereco.php" class="signup" method="POST">
            ...
            <div class="caixa">
               ...
               <input class="box" type="tel" id="telefone" required name="telefone">
            </div>
            ...
            <input type="submit" name="seguir" value="seguir" class="test">
