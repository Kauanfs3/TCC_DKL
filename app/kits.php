...
<body>
  ...
  <nav class="cabecalho" id="navbar">
    ...
    <a href="#" id="conf" class="conf"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="sacola-comp bi bi-gear-fill" viewBox="0 0 16 16">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <a class="ver" href="promocoes.php">Ver mais...</a>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <a class="ver" href="refils.php">Ver mais...</a>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <a class="ver" href="kits.php">Ver mais...</a>
    </div>
