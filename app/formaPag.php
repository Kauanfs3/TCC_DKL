      ...
      <div class="accordion" id="accordionExample">
         <div class="card-p">
            <div class="card" id="headingOne">
               <button class="t-item" type="button" data-toggle="collapse" data-target="#collapseOne"
                  ...
                  <div class="form-inner">
                     <form action="#" class="signup" method="POST">
                        ...
                        <div class="row">
                           ...
                           <div class="caixa col-6">
                              <label class="ti">CVV</label><span class="obg">*</span>
                              <input name="myinput_drs" oninput="maxLengthCheck(this)" type="number" maxlength="3" min="1"
                                 max="999" />
                           </div>
                        </div>
         ...
         <div class="card-p">
            <div class="card" id="headingTwo">
               <button class="t-item" type="button" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
               <div class="dados">
                  <p class="p1">Clique no botão "Finalizar Pedido" para confirmar seu pedido e imprimir seu boleto</p>
                  <p>Imprima o boleto e pague na agência bancária de sua preferência ou através dos serviços de Internet
                     Banking.</p>
                  <p> Acompanhe o prazo de validade do seu boleto, ele não será enviado pelos Correios.</p>
               </div>
            </div>
         </div>
         ...
         <div class="card-p">
            <div class="card" id="headingThree">
               <button class="t-item" type="button" data-toggle="collapse" data-target="#collapseThree"
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
               <div class="dados">
                  <p class="p1">1. Clique em "Finalizar Pedido";</p>
